...
const HeroActions = () => {
    ...
    const handleCreateSession = async () => {
        ...
        try {
            const res = await fetch(`${API_URL}/create-collab-room`, {
                method: 'POST',
                headers: {
...
export const Hero = () => {
  return (
    <section className="min-h-screen relative flex items-center justify-center px-6 overflow-hidden -mt-20 pt-20">
      <div className="absolute bg-gradient-to-br from-gray-800 via-gray-600 to-gray-800" style={{ top: '-100px', left: 0, right: 0, bottom: 0 }}></div>
      <div 
